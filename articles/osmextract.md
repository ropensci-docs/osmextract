...
oe_read(its_gpkg)
#> Reading layer `lines' from data source `/tmp/RtmpWluSLG/test_its-example.gpkg' using driver `GPKG'
...
#> Reading layer `lines' from data source `/tmp/RtmpWluSLG/test_its-example.osm.pbf' using driver `OSM'
...
#> from data source `/tmp/RtmpWluSLG/test_its-example.gpkg' using driver `GPKG'
